...
const firebaseConfig = {
  ...
  authDomain: "educonnect-fa194.firebaseapp.com",
  projectId: "educonnect-fa194",
  storageBucket: "educonnect-fa194.firebasestorage.app",
...
async function addUsernames() {
  try {
    ...
    for (const userDoc of usersSnapshot.docs) {
      ...
      console.log(`✅ Added username "${username}" to ${email} (${role})`);
      updated++;
    }
