...
2. Select your project: **EduConnect Mobile**
...
⚠️ **WARNING**: The above rules allow anyone to read/write to your database. Use only for development and testing!
...
- ✅ App **won't crash**
- ✅ User sees **helpful alert messages**
- ✅ App falls back to **mock/demo data**
