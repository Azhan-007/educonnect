...
2. Select project: `educonnect-fa194`
...
✅ Use consistent time formats (24-hour)  
✅ Keep period numbers sequential (1, 2, 3...)  
✅ Use meaningful color coding  
✅ Include break times as periods if needed  
✅ Test changes on mobile app after updating  
✅ Keep teacher names consistent across entries  
✅ Double-check room assignments  

❌ Don't skip period numbers  
❌ Don't use 12-hour time format (AM/PM)  
❌ Don't use different day abbreviations  
❌ Don't forget to set periodNumber for sorting
