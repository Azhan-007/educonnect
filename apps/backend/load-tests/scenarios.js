/**
 * EduConnect Load Testing Suite (k6)
...
function textSummary(data, options) {
  ...
  if (httpReqDuration) {
    summary += `✓ Response time p(95) < 500ms: ${httpReqDuration["p(95)<500"] ? "PASS" : "FAIL"}\n`;
    summary += `✓ Response time p(99) < 1000ms: ${httpReqDuration["p(99)<1000"] ? "PASS" : "FAIL"}\n`;
  }
