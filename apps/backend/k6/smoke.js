/*
 * k6 Load Test — EduConnect API
 *
 * Critical path: Login → Dashboard → Students CRUD → Attendance → Logout
 *
 * Run:
 ...
 *   AUTH_TOKEN       — pre-generated Firebase ID token
 *   SCHOOL_ID        — tenant school ID for X-School-Id header
 */
...
export const options = {
  ...
  // Smoke test defaults — override via CLI for load/stress
  vus: 1,
  duration: "30s",
};
