 ...
 *   educonnect_active_tenants      — gauge (unique schoolIds in sliding window)
...
register.setDefaultLabels({ app: "educonnect-api" });
...
const criticalRequestDuration = new Histogram({
  name: "educonnect_critical_request_duration_seconds",
...
const criticalSlowRequestsTotal = new Counter({
  name: "educonnect_critical_slow_requests_total",
...
const authLookupCacheEventsTotal = new Counter({
  name: "educonnect_auth_lookup_cache_events_total",
...
const dashboardQueryDuration = new Histogram({
  name: "educonnect_dashboard_query_duration_seconds",
...
const overloadShedRequestsTotal = new Counter({
  name: "educonnect_overload_shed_requests_total",
...
const queueActiveJobs = new Gauge({
  name: "educonnect_queue_active_jobs",
...
const queueFailedJobs = new Gauge({
  name: "educonnect_queue_failed_jobs",
...
const queueOldestWaitingAgeSeconds = new Gauge({
  name: "educonnect_queue_oldest_waiting_job_age_seconds",
