...
export default function PricingPage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        'No, there are no setup fees. You can start using EduConnect immediately after signing up. We also offer free data migration assistance for Pro and Enterprise plans.',
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-slate-900">EduConnect</h1>
      ...
      <section className="pt-20 pb-8 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-500 max-w-2xl mx-auto mb-10">
            Welcome to EduConnect — choose the plan that best fits your school&apos;s needs.
      ...
      <section className="py-20 px-4 bg-slate-900 relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-slate-400 text-lg mb-10 max-w-2xl mx-auto">
            Join thousands of schools already using EduConnect to streamline their operations.
          </p>
          <button
