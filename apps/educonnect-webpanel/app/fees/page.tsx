...
export default function FeesPage() {
  ...
  const handleExportPrint = () => {
    exportToPrint({ title: 'Fee Records', schoolName: currentSchool?.name || 'EduConnect School', headers: feeExportHeaders, rows: feeExportRows, filename: `fees-${format(new Date(), 'yyyy-MM-dd')}` });
  };
  const handleExportCSV = () => {
    exportToCSV({ title: 'Fee Records', schoolName: currentSchool?.name || 'EduConnect School', headers: feeExportHeaders, rows: feeExportRows, filename: `fees-${format(new Date(), 'yyyy-MM-dd')}` });
