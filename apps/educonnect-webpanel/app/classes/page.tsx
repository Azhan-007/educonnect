...
export default function ClassesPage() {
  ...
  const handlePrint = () => {
    exportToPrint({ title: 'Classes & Sections', schoolName: currentSchool?.name || 'EduConnect School', headers: classExportHeaders, rows: classExportRows, filename: `classes-${format(new Date(), 'yyyy-MM-dd')}` });
  };
  const handleCSV = () => {
    exportToCSV({ title: 'Classes & Sections', schoolName: currentSchool?.name || 'EduConnect School', headers: classExportHeaders, rows: classExportRows, filename: `classes-${format(new Date(), 'yyyy-MM-dd')}` });
  };
