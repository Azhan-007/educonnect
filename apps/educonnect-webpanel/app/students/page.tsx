...
export default function StudentsPage() {
  ...
  const handleExportPrint = () => {
    ...
    exportToPrint({
      ...
      schoolName: currentSchool?.name || 'EduConnect School',
      headers,
      rows,
  ...
  const handleExportCSV = () => {
    ...
    exportToCSV({ title: 'Student Records', schoolName: currentSchool?.name || 'EduConnect School', headers, rows, filename: `students-${format(new Date(), 'yyyy-MM-dd')}` });
