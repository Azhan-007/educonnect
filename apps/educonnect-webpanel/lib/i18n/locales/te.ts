...
const te: TranslationKeys = {
  ...
  auth: {
    ...
    signInSubtitle: "మీ EduConnect ఖాతాలో సైన్ ఇన్ చేయండి",
  },
  dashboard: {
    title: "డాష్‌బోర్డ్",
  ...
  attendance: {
    ...
    late: "ఆలస్యం",
    excused: "సెలవు",
    markAttendance: "హాజరు మార్క్ చేయండి",
  ...
  settings: {
    ...
    resetDefaults: "డీఫాల్ట్‌లకు రీసెట్ చేయండి",
  },
};
