...
const bn: TranslationKeys = {
  ...
  auth: {
    ...
    welcome: "স্বাগতম",
    signInSubtitle: "আপনার EduConnect অ্যাকাউন্টে সাইন ইন করুন",
  },
  dashboard: {
    title: "ড্যাশবোর্ড",
  ...
  students: {
    ...
    editStudent: "শিক্ষার্থী সম্পাদনা করুন",
    studentDetails: "শিক্ষার্থী বিবরণ",
  ...
  teachers: {
    ...
    editTeacher: "শিক্ষক সম্পাদনা করুন",
    subject: "বিষয়",
